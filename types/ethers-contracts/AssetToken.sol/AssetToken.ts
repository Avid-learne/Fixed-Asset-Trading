...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface AssetTokenInterface extends Interface {
    getFunction(nameOrSignature: "DEFAULT_ADMIN_ROLE" | "MINTER_ROLE" | "allowance" | "approve" | "balanceOf" | "burn" | "decimals" | "depositMetadata" | "getRoleAdmin" | "grantRole" | "hasRole" | "mint" | "name" | "renounceRole" | "revokeRole" | "setDepositMetadata" | "supportsInterface" | "symbol" | "totalSupply" | "transfer" | "transferFrom"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Approval" | "DepositMetadataSet" | "RoleAdminChanged" | "RoleGranted" | "RoleRevoked" | "Transfer"): EventFragment;
...
encodeFunctionData(functionFragment: 'depositMetadata', values: [BigNumberish]): string;
...
encodeFunctionData(functionFragment: 'setDepositMetadata', values: [BigNumberish, string]): string;
...
decodeFunctionResult(functionFragment: 'depositMetadata', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'setDepositMetadata', data: BytesLike): Result;
...
decodeFunctionResult(functionFragment: 'transferFrom', data: BytesLike): Result;
    ...
    export namespace DepositMetadataSetEvent {
      export type InputTuple = [depositId: BigNumberish, metadata: string];
      export type OutputTuple = [depositId: bigint, metadata: string];
      export interface OutputObject {depositId: bigint, metadata: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    depositMetadata: TypedContractMethod<
      [arg0: BigNumberish, ],
      [string],
      'view'
    >
    ...
    setDepositMetadata: TypedContractMethod<
      [depositId: BigNumberish, metadata: string, ],
      [void],
      'nonpayable'
    >
...
getFunction(nameOrSignature: 'decimals'): TypedContractMethod<
      ...
      'view'
    >;
getFunction(nameOrSignature: 'depositMetadata'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [string],
      'view'
    >;
...
getFunction(nameOrSignature: 'revokeRole'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'setDepositMetadata'): TypedContractMethod<
      [depositId: BigNumberish, metadata: string, ],
      [void],
      'nonpayable'
    >;
...
getEvent(key: 'DepositMetadataSet'): TypedContractEvent<DepositMetadataSetEvent.InputTuple, DepositMetadataSetEvent.OutputTuple, DepositMetadataSetEvent.OutputObject>;
...
getEvent(key: 'Transfer'): TypedContractEvent<TransferEvent.InputTuple, TransferEvent.OutputTuple, TransferEvent.OutputObject>;
    ...
    filters: {
      ...
      'DepositMetadataSet(uint256,string)': TypedContractEvent<DepositMetadataSetEvent.InputTuple, DepositMetadataSetEvent.OutputTuple, DepositMetadataSetEvent.OutputObject>;
      DepositMetadataSet: TypedContractEvent<DepositMetadataSetEvent.InputTuple, DepositMetadataSetEvent.OutputTuple, DepositMetadataSetEvent.OutputObject>;
