...
const mockUsers: User[] = [
  {
    id: 'USR-001',
    name: 'John Admin',
    email: 'john.admin@assetbridge.com',
    role: 'SUPER_ADMIN',
    status: 'active',
  ...
  },
  {
    ...
    email: 'michael.anderson@firstbank.com',
    role: 'BANK_OFFICER',
    status: 'active',
  ...
  },
  {
    id: 'USR-006',
    name: 'Dr. Robert Chen',
    email: 'robert.chen@cityhospital.com',
    role: 'HOSPITAL_ADMIN',
    status: 'active',
    organization: 'City General Hospital',
    lastLogin: '2024-12-05T18:00:00Z',
  ...
  },
  {
    id: 'USR-007',
    name: 'Lisa Martinez',
    email: 'lisa.martinez@cityhospital.com',
    role: 'HOSPITAL_STAFF',
    status: 'active',
    organization: 'City General Hospital',
    lastLogin: '2024-12-06T08:00:00Z',
  ...
  },
  {
    id: 'USR-008',
    name: 'James Wilson',
    email: 'james.wilson@firstbank.com',
    role: 'BANK_OFFICER',
    status: 'active',
    organization: 'First National Bank',
    lastLogin: '2024-12-04T15:30:00Z',
  ...
  },
  {
    ...
    role: 'PATIENT',
    status: 'active',
    lastLogin: '2024-12-06T06:15:00Z',
