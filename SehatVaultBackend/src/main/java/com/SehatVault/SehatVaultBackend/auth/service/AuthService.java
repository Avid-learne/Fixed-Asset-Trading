    ...
    public AuthResponse signup(SignupRequest request) {
        ...
        try {
            ...
            if (request.getHospitalName() != null && !request.getHospitalName().trim().isEmpty()) {
                Optional<com.SehatVault.SehatVaultBackend.hospital.entity.Hospital> hospitalOpt = hospitalRepository
                ...
                if (hospitalOpt.isPresent()) {
                    ...
                    if (roleType == Role.RoleType.hospital_admin) {
                        com.SehatVault.SehatVaultBackend.hospital.entity.Hospital newHospital = new com.SehatVault.SehatVaultBackend.hospital.entity.Hospital();
                        ...
                        newHospital.setVerificationStatus(
                                com.SehatVault.SehatVaultBackend.hospital.entity.Hospital.VerificationStatus.PENDING);
                        newHospital.setCreatedAt(java.time.LocalDateTime.now());
                        newHospital.setUpdatedAt(java.time.LocalDateTime.now());
                        com.SehatVault.SehatVaultBackend.hospital.entity.Hospital savedHospital = hospitalRepository
                                .save(newHospital);
